...
def train(
    ...
    def train_one_batch(state, inputs):
        ...
        def loss_fn(
            ...
            return mean_loss + jnp.mean(loss_multipliers * jax.vmap(
                policy_loss, in_axes=0, axis_name="batch")
                                        (x.q_values, logits, key)), (aux_losses)
